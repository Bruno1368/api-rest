...
@DataJpaTest
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) // usar o mesmo banco de dados (mysql) do projeto
@ActiveProfiles("test")
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var medico = cadastrarMedico("Bruno", "bruno.ed@med.com", "123456", Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("Anderson", "andi@andi.com", "03989840002");
