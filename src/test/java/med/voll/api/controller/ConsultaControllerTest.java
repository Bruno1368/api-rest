...
class ConsultaControllerTest {
    ...
    @WithMockUser //um usuário mockado, para não precisar logar
    ...
    @Test
    @DisplayName("Deveria devolver codigo http 200 quando informacoes estão validas")
    @WithMockUser //um usuário mockado, para não precisar logar
    void agendar_cenario2() throws Exception {
        ...
        when(agendaDeConsultas.agendar(any())).thenReturn(
               dadosDetalhamento); //quando o mock agendadeconsultas for chamado, chamar o metodo agendar, passar qualquer argumento, e retornar o detalhamento
